...
*/
var APIUrl = "https://chart.googleapis.com/chart?"; //'http://chart.apis.google.com/chart?'
...
$.extend(GChart.prototype, {
	...
	seriesForXYLines: function(series) {
		...
		for (var i = 0; i < series.length; i++) {
			...
			for (var j = 0; j < series[i].data.length; j++) {
				...
				//alert(series[i].data[j][0]);
				//alert(series[i].data[j][1]+"tt");
	...
	_generateChart: function(options) {
		...
		var img = APIUrl  + this.addSize(type, options) +
