...
public class VerifyLandingOnAttachmentPage extends TestSuiteBase {
	...
	public void Test_VerifyLandingOnAttachmentPage(String Role) throws Exception
	{
		...
		{	
			...
			boolean PageHeadingResult=compareStrings(actualAttachmentPageHeadingText,resourceFileConversion.getProperty("TM_AttachmentTab_AttachmentDetailsText"));
			
			if(PageHeadingResult==true){
