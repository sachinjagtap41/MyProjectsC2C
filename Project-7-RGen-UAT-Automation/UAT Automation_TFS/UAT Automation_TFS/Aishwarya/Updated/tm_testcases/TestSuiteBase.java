...
{	
	...
	//				String testPassCreatedResult=wait.until(ExpectedConditions.visibilityOf(getElement("TestPassCreateNew_testPassSuccessMessageText_Id"))).getText();
		...
		// Create Testers for that project	
...
//					String testCaseCreatedResult=wait.until(ExpectedConditions.visibilityOf(getElement("TestCaseCreateNew_testCaseSuccessMessageText_Id"))).getText();
		...
		//			String testStepCreatedResult=wait.until(ExpectedConditions.visibilityOf(getElement("TestStepCreateNew_testStepSuccessMessageText_Id"))).getText();
