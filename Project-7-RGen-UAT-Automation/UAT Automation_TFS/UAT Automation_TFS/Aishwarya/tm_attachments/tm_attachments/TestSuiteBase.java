...
public class TestSuiteBase extends TestBase{
	...
	// check if TM_Attachments Suite has to be skipped
		...
		//common function for creating project
				public void createProject(String group, String portfolio, String project, String version, String endMonth, String endYear, String endDate, String versionLead ) throws IOException, InterruptedException
				{
