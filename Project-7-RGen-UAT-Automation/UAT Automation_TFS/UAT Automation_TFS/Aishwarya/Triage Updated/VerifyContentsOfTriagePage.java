	...
	ArrayList<Credentials> tester;
		...
		// Runmode of test case in a suite
			...
			public void checkTestSkip(){
				...
				System.out.println(" Executing VerifyContentsOfTriagePage Test Case");				
			...
			public void Test_VerifyContentsOfTriagePage(String Role, String GroupName, String Portfolio, 
					String ProjectName, String Version1, String Version2, String endMonth, String endYear, 
					String endDate, String	VersionLead, String testPassName1, String testManager, 
					String testPassName2, String testerName, String	Role1, String Role2, 
					String	testCaseName, String testStepName,String assignedRole, String expectedResult)
					throws Exception
			{
				count++;
				...
				if(isLoginSuccess)
				{
						...
						System.out.println(" Closed Browser after creating data on Test Management tab.");
		 				...
		 				else
		 				{
		 					...
		 					//Ekta - How will you take screenshot on closed browser
		 					TestUtil.takeScreenShot(this.getClass().getSimpleName(),"TMLoginFailed");
		 				}
		 				APP_LOGS.debug("Closing Browser... ");
		 				//EKTA -- If the login fails, session id is null exception will be throws as Selenium would try closing the browser at the time no browser is active
		 				closeBrowser();
				}	
				else 
				{
			...
			private void DDContentVerifiaction(String expectedContentArray[], String actualContentArray[], String DDName)
			{
				...
				//Ekta else block needed to update fail variable
			}
