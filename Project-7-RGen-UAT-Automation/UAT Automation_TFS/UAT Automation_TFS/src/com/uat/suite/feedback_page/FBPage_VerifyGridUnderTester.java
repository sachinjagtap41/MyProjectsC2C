...
public class FBPage_VerifyGridUnderTester extends TestSuiteBase {
	...
	String testStepExpectedResultGivenByTester="Creation should be successful Of Test Step : feedbackPage_GridVerificationUnderTester -Test Step_";
	String testStepActualResultExpectedByTester="Successful Creation Of Test Step : feedbackPage_GridVerificationUnderTester -Test Step_";
	...
	public void feedbackPage_GridVerificationUnderTester (String role,String groupName,String portfolioName,String projectName, 
			String version,String endMonth, String endYear, String endDate, String versionLead ,String testPassName, 
			String testCaseName, String testStepName, String numberOfTestStepsToBeCreated,String expectedTestStepResults,String testManager,String testers,String addRole,String providedFeedbackForTestStepByTester,String ActionColumnStatusAfterProvidingFeedback) throws Exception
	{
		count++;
		...
		if(isLoginSuccess)
		{
			...
			try
			{
				...
				APP_LOGS.debug("______________________________________________________________________________________________________________________________");			
				...
				if (login(tester.get(0).username,tester.get(0).password, "Tester")) 
				{
					...
					APP_LOGS.debug("Performing Testing On Test Pass : "+ testPassName +" to verify Provide Feedback on all Test Steps ");
					...
					String provideFeedbackForTestPass="Acceptance Testing Of Project- \"feedbackPage_GridVerificationUnderTester -Test Step_\" is done Very SATISFACTORILY ";
					...
					System.out.println(selectTestPass.size());
					...
					System.out.println(selectTester.size());
					...
					{
						APP_LOGS.debug("Test Id, Associated Test Case name, Test Step name, Result & Action column.are showing properly in Test Step Feedback Grid For Tester  (PASS) .");
						comments+=" \n2. Test Id, Associated Test Case name, Test Step name, Result & Action column.are showing properly in Test Step Feedback Grid For Tester  (PASS) .";
					}
					else
					{
						fail=true;
						...
						TestUtil.takeScreenShot(this.getClass().getSimpleName(), "Column Names in TestStep Feedback Grid are Not showing ( Failure)");
					}
					...
					System.out.println(rowCountOnTestStepFeedbackPage.size());
					...
					for(int i=1;i<=totalTestStepsToBeCreated;i++)
					{
						...
						{
							String actionStatusProvideFeedback = getObject("FeedbackPage_ProvideFeedbackPerTestStepXpath1","FeedbackPage_ProvideFeedbackPerTestStepXpath2",i).getText();
									...
									//havent verified Test Step Id As it's Dyanamic
							{
								...
								String actionStatusEditFeedback = getObject("FeedbackPage_ProvideFeedbackPerTestStepXpath1","FeedbackPage_ProvideFeedbackPerTestStepXpath2",i).getText();
								
								if(actionStatusEditFeedback.equals(ActionColumnStatusAfterProvidingFeedback) && !(actionStatusProvideFeedback.equals(actionStatusEditFeedback)))
								{
									counter++;
									APP_LOGS.debug("After Providing Feedback For Test Step ,' Provide Feedback ' Status  is changed to Status 'Edit Feedback' as expected ( PASS ) ");
								...
								else
								{
									...
									fail=true;
									assertTrue(false);
									APP_LOGS.debug("After Providing Feedback For Test Step ,' Provide Feedback ' Status NOT changed to Status 'Edit Feedback' as expected ( FAIL ) ");
									comments+="\n After Providing Feedback For Test Step ,' Provide Feedback ' Status  is NOT changed to Status 'Edit Feedback' as expected ( FAIL ) ";
									TestUtil.takeScreenShot(this.getClass().getSimpleName(), "StatusColumnNOTChangedAfterProvidingFeedBack");
						...
						{	
							...
							comments+="\n3. Tester is able to see  only 10 Test Steps in Grid  on one paging Successfully ( Pass )";
							...
							{	
								...
								comments+="\n4. There are more than  10 Test Steps are Available on Feedback Page Grid...So Clicking On Next Link to Verify Further Test Steps  (Pass )";
								i=0;
								continue;
							}
							else
					...
					{
						APP_LOGS.debug("Tester is able to see All test Steps with associate Test Cases and Result Of Selected Test Pass on Test Step Feedback Grid Successfully ( PASS )");
						APP_LOGS.debug("Tester is able to see entered details i.e. Project Name, Test Pass Name , Test Case Name,, Test Step Name, Result, Expected Result,Previous Link, Next Link, and Actual Result of Test Step on Provide Feedback Popup Successfully  ( PASS )");
						APP_LOGS.debug("After Providing Feedback For Test Step ,' Provide Feedback ' Status  is changed to Status 'Edit Feedback' as expected ( PASS ) ");

						comments+="\n5. Tester is able to see All test Steps with associate Test Cases and Result Of Selected Test Pass on Test Step Feedback Grid Successfully ( PASS )";
						comments+="\n6. Tester is able to see entered details i.e. Project Name, Test Pass Name , Test Case Name,, Test Step Name, Result, Expected Result,Previous Link, Next Link, and Actual Result of Test Step on Provide Feedback Popup Successfully  ( PASS )";
						comments+="\n7. After Providing Feedback For Test Step ,' Provide Feedback ' Status  is changed to Status 'Edit Feedback' as expected ( PASS ) ";
					...
					else
					{
						fail=true;
						assertTrue(false);
						APP_LOGS.debug("Tester is NOT able to see All test Steps with associate Test Cases and Result Of Selected Test Pass on Test Step Feedback Grid properly ( FAIL )");
						APP_LOGS.debug("Tester is NOT able to see entered details i.e. Project Name, Test Pass Name , Test Case Name,, Test Step Name, Result, Expected Result,Previous Link, Next Link, and Actual Result of Test Step on Provide Feedback Popup  properly ( FAIL )");
						comments+="\n.Tester is NOT able to see All test Steps with associate Test Cases and Result Of Selected Test Pass on Test Step Feedback Grid properly ( FAIL )";
						comments+="\n.Tester is NOT able to see entered details i.e. Project Name, Test Pass Name , Test Case Name,, Test Step Name, Result, Expected Result,Previous Link, Next Link, and Actual Result of Test Step on Provide Feedback Popup  properly  ( FAIL )";
						APP_LOGS.debug("After Providing Feedback For Test Step ,' Provide Feedback ' Status  is NOT changed to Status 'Edit Feedback' as expected ( FAIL ) ");
						comments+="\n After Providing Feedback For Test Step ,' Provide Feedback ' Status  is NOT changed to Status 'Edit Feedback' as expected ( FAIL ) ";
					...
					//Verifying Next Link Functionality ON Provide Feedback PoP Up

					APP_LOGS.debug("Verifying Next Link Functionality Of Provide Feedback Pop Up");
					...
					if(testStepNameInGrid.get(totalRowCountOnFeedbackPageGrid).equals(testStepName+(totalRowCountOnFeedbackPageGrid+1)) && associateTestCaseNameInGrid.get(totalRowCountOnFeedbackPageGrid).equals(testCaseName)&&testStepExecutionResultInTestStepFeedbackGrid.get(totalRowCountOnFeedbackPageGrid).equals(testStepExecutionResultOnTestingPage.get(totalRowCountOnFeedbackPageGrid)))
					{
						...
						for(i=1;i<=totalTestStepsToBeCreated;i++)
						{
								...
								//									//havent verified Test Step Id As it's Dyanamic
							{
								...
								else
								{
									if(!(isNextLinkEnabled.contains("cursor: pointer")))
									{
										APP_LOGS.debug("After continue clicking on Next Link of Provide Feedback PopUp.. As it reached to last Test Step of Test Pass therefore Provide Feedback PopUp is not showing the information about next Test Step as Expected  ( Next Link Disabled  ) ( Pass )");
										comments+="\n8. After continue clicking on Next Link of Provide Feedback PopUp.. As it reached to last Test Step of Test Pass therefore Provide Feedback PopUp is not showing the information about next Test Step as Expected  ( Next Link Disabled  ) ( Pass )";
										break;
									}
						...
						APP_LOGS.debug("Verifying Previous Link Functionality Of Provide Feedback Pop Up");
						...
						for(int j =totalRowCountOnFeedbackPageGrid;j<=totalTestStepsToBeCreated;j--)
						{
								...
								//havent verified Test Step Id As it's Dyanamic
							{
								...
								else
								{
									if(!(isPreviousLinkEnabled.contains("cursor: pointer")))
									{	
										APP_LOGS.debug("After continue clicking on previous Link of Provide Feedback PopUp  As it reached to First Test Step of Test Pass therefore Provide Feedback PopUp is not showing the information about Previous Test Step as Expected  ( Previous Link Disabled  ) ( Pass )");  
										comments+="\n9. After continue clicking on previous Link of Provide  Feedback PopUp  As it reached to First Test Step of Test Pass therefore Provide Feedback PopUp is not showing the information about Previous Test Step as Expected  ( Previous Link Disabled  ) ( Pass )";  
										break;
									}
							...
							else
							{
								fail=true;
								assertTrue(false);
								APP_LOGS.debug("Provide Feedback  Pop Up Text Information is not showing properly with Project Name, Test Pass Name , Test Case Name,, Test Step Name, Status Result, Expected Result, and Actual Result (Fail )");
								comments+="\nProvide  Feedback Pop Up Text Information is not showing properly with Project Name, Test Pass Name , Test Case Name,, Test Step Name, Status Result, Expected Result, and Actual Result (Fail )";
								TestUtil.takeScreenShot(this.getClass().getSimpleName(), "ProvideFeedbackPopUpTextInformationNotShowingProperly");
							}
					...
					else
					{
						fail=true;
						assertTrue(false);
						APP_LOGS.debug("Created Test Step ,Test case and Status Result is NOT showing on Feedback Page When Tester logged in to verify Provide Feedback ( Fail ) ");
						comments+="\nCreated Test Step ,Test case and Status Result is NOT showing on Feedback Page When Tester logged in to verify Provide Feedback ( Fail ) ";
			...
			String testStepName, String testStepExpectedResults, String testCasesToBeSelected, String rolesToBeSelected) throws IOException, InterruptedException
	{
		...
		try {
			...
			APP_LOGS.debug(" 1. Test Pass : " +"'"+testPassName+ "'" + "  with Test Case : "+"'" + testCasesToBeSelected+"'" + "  along with Test Steps is Created Successfully  (Pass) .");
			comments+="1.Test Pass : " +"'"+testPassName+ "'" +"  with Test Case : " + "'" + testCasesToBeSelected+"'" + "  along with Test Steps is Created Successfully  (Pass) .";
