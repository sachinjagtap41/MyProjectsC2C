...
public class TestSuiteBase extends TestBase
{
	...
	{
		initialize();
		APP_LOGS.debug("Checking Runmode of Feedback Page Suite");
		if(!TestUtil.isSuiteRunnable(suiteXls, "Feedback Page Suite")){
			APP_LOGS.debug("Skipped Feedback  Page Suite as the runmode was set to NO");
			throw new SkipException("Runmode of Feedback Page Suite set to NO ... So Skipping all tests in Testing Page Suite");
		}
