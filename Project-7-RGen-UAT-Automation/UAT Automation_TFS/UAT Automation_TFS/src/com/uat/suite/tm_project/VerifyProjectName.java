...
public class VerifyProjectName extends TestSuiteBase  {
	...
	// Runmode of test case in a suite
		...
		public void verifyProjectName(String Role,String GroupName,String PortfolioName,String ProjectName, String Version,String EndMonth, String EndYear, String EndDate, String VersionLead,String Expected_Messsage ) throws Exception
		{
			count++;
			comments="";
			...
			APP_LOGS.debug(" Executing Test Case -> VerifyProjectName...");
			...
			{	 
				...
				{		
					...
					//String actual_SaveProjectandVersion_SuccessMessage = wait.until(ExpectedConditions.visibilityOf(getElement("ProjectCreateNew_projectSuccessMessageText_Id"))).getText();
				   
					String actual_SaveProjectandVersion_SuccessMessage;
					
					if (Expected_Messsage.contains("successfully"))
					...
					if (compareStrings(Expected_Messsage, actual_SaveProjectandVersion_SuccessMessage)) 
					{
						...
						if (login("Admin")) 
						{
							...
							if (ProjectName.matches("[[a-z][A-Z][0-9]-_ ]*"))
							{
					...
					{
						fail = true;
						TestUtil.takeScreenShot(this.getClass().getSimpleName(), "ProjectSaveUnsuccessfull");
					}					
		...
		public void SelectorCreationGroupAndPortfolio(WebElement DropDownList, WebElement AddButton, String InputtedTestData) throws IOException
		{
			...
			catch(Throwable t)
			{
				 fail=true;
				 t.printStackTrace();
				 TestUtil.takeScreenShot(this.getClass().getSimpleName(), "VerifyProjectNameError");
