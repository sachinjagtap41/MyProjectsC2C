...
{
	boolean flag= false;
	// check if TM_Attachments Suite has to be skipped
	@BeforeSuite
	public void checkSuiteSkip() throws Exception
	{
		...
		{
			APP_LOGS.debug("Skipped Test Management Attachments Suite  as the runmode was set to NO");
			throw new SkipException("Runmode of Test Management Attachments Suite set to NO ... So Skipping all tests in Test Management Attachments Suite");
		}
