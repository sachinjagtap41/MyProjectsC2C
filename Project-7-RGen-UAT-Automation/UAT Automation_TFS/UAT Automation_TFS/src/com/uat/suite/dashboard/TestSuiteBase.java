...
public class TestSuiteBase extends TestBase
{
	...
	public void checkSuiteSkip() throws Exception{
		initialize();
		APP_LOGS.debug("Checking Runmode of Dashboard Suite");
		if(!TestUtil.isSuiteRunnable(suiteXls, "Dashboard Suite"))
		{
			APP_LOGS.debug("Skipped Dashboard Suite  as the runmode was set to NO");
			throw new SkipException("Runmode of Dashboard Suite set to NO ... So Skipping all tests in Dashboard Suite");
		}
	...
	public boolean compareDropDownSelectionText(WebElement dropDownList,WebElement SelectionList, String selectionText) throws IOException, InterruptedException 
	{
		Thread.sleep(500);
