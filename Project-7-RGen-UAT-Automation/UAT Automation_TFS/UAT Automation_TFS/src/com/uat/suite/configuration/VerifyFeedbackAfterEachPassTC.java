...
public class VerifyFeedbackAfterEachPassTC extends TestSuiteBase
{
	...
	@BeforeTest
	public void testVerifyFeedbackAfterEachPassTC() throws Exception
	{
	...
	public void testVerifyDescriptionTableArea( String Role, String GroupName,String PortfolioName,String ProjectName, String Version,
			...
			String TP1_TC2_TestStepName1, String TP1_TC2_TestStepName2,String TestStepExpectedResult, String AssignedRole1) throws Exception
		{
			count++;
			    	 ...
			    	 if(login(testManager.get(0).username,testManager.get(0).password, "Test Manager"))
			 	     {
						...
						if (login(tester.get(0).username,tester.get(0).password, "Tester")) 
						{
							...
							if ( ! waitForElementVisibilityPrivate("TestingPage_feedbackPopupDiv") ) 
							{
								...
								APP_LOGS.debug("Feedback popup is NOT Displayed when some of Test Step are 'Fail'.");
								
								comments += "\n- Feedback popup is NOT Displayed when some of Test Step are 'Fail'.";
							...
							else 
							{
								...
								APP_LOGS.debug("Feedback popup is Displayed when some of Test Step are 'Fail'.(Fail) ");
								
								comments += "\n- Feedback popup is Displayed when some of Test Step are 'Fail'. (Fail)";
							...
							if ( waitForElementVisibilityPrivate("TestingPage_feedbackPopupDiv")) 
							{
								...
								APP_LOGS.debug("Feedback popup is Displayed when all test steps are 'Pass'.");
								
								comments += "\n- Feedback popup is Displayed when all test steps are 'Pass'.";
							...
							else 
							{
								...
								APP_LOGS.debug("Feedback popup is NOT Displayed when all test steps are 'Pass'.(Fail) ");
								
								comments += "\n- Feedback popup is NOT Displayed when all test steps are 'Pass'. (Fail)";
							...
							String continueTestingButton = getObject("TestingPage_feedbackPopupContinueTestingButton").getText();
							
							if (compareStrings("Continue Testing", continueTestingButton)) 
							{
								APP_LOGS.debug("'Continue Testing' button is displayed after feedback is been provided.");
								
								comments += "\n- 'Continue Testing' button is displayed after feedback is been provided.";
								
								getObject("TestingPage_feedbackPopupContinueTestingButton").click();
							...
							else 
							{
								...
								APP_LOGS.debug("'Continue Testing' button is NOT displayed after feedback is been provided.(Fail) ");
								
								comments += "\n- 'Continue Testing' button is NOT displayed after feedback is been provided. (Fail)";
								
								TestUtil.takeScreenShot(this.getClass().getSimpleName(), "'Continue Testing' button is NOT displayed");
								
							}
							
							String testCaseAftercontinueTestingButtonClick = selectTestCase.getFirstSelectedOption().getAttribute("title");
							
							if (compareStrings(TP1_TestCaseName2, testCaseAftercontinueTestingButtonClick)) 
							{
								APP_LOGS.debug("Test Case has been switched next Test case after clicking 'Continue Testing' button.");
								
								comments += "\n- Test Case has been switched next Test case after clicking 'Continue Testing' button.";
							...
							else 
							{
								...
								APP_LOGS.debug("Test Case has NOT been switched next Test case after clicking 'Continue Testing' button.(Fail) ");
								
								comments += "\n- Test Case has NOT been switched next Test case after clicking 'Continue Testing' button.(Fail)";
