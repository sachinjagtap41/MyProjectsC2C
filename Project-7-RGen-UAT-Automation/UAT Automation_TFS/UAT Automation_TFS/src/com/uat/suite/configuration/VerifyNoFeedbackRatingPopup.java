...
public class VerifyNoFeedbackRatingPopup extends TestSuiteBase
{
	...
	public void testVerifyDescriptionTableArea( String Role, String GroupName,String PortfolioName,String ProjectName, String Version,
			...
			String TP1_TestCaseName1,String TP1_TestCaseName2,String TP1_TC1_TestStepName1,	String TP1_TC2_TestStepName1, 
			String TestStepExpectedResult, String AssignedRole1) throws Exception
		{
			count++;
			    	 ...
			    	 if(login(testManager.get(0).username,testManager.get(0).password, "Test Manager"))
			 	     {
						...
						getElement("Configuration_noRatingPopup_Id").click();
						...
						if (login(tester.get(0).username,tester.get(0).password, "Tester")) 
						{
							...
							if ( waitForElementVisibilityPrivate("TestingPage_feedbackPopupDiv") == false) 
							{
								
								APP_LOGS.debug("Feedback popup is NOT Displayed when all test steps in a TEST CASE are 'Pass'.");
								
								comments += "\n- Feedback popup is NOT Displayed when all test steps in a TEST CASE are 'Pass'.";
							...
							else 
							{
								...
								APP_LOGS.debug("Feedback popup is Displayed when all test steps in a TEST CASE are 'Pass'.(Fail) ");
								
								comments += "\n- Feedback popup is Displayed when all test steps in a TEST CASE are 'Pass'. (Fail)";
							...
							{
								APP_LOGS.debug("Test Case has been switched next Test case without providing feedback.");
								
								comments += "\n- Test Case has been switched next Test case without providing feedback.";
							...
							else 
							{
								...
								APP_LOGS.debug("Test Case has been switched next Test case without providing feedback.(Fail) ");
								
								comments += "\n- Test Case has been switched next Test case without providing feedback.(Fail)";
							...
							if ( waitForElementVisibilityPrivate("TestingPage_feedbackPopupDiv") == false) 
							{
								...
								APP_LOGS.debug("Feedback popup is NOT Displayed when testing is complete of a TEST PASS.");
								
								comments += "\n- Feedback popup is NOT Displayed when testing is complete of a TEST PASS.";
							...
							else 
							{
								...
								APP_LOGS.debug("Feedback popup is Displayed when testing is complete of a TEST PASS.(Fail) ");
								
								comments += "\n- Feedback popup is Displayed when testing is complete of a TEST PASS.(Fail)";
