...
public class VerifyTestStepBulkDelete extends TestSuiteBase{
	...
	// Runmode of test case in a suite
		...
		public void checkTestSkip(){
			APP_LOGS.debug(" Executing VerifyTestStepBulkDelete Test Case");
			System.out.println(" Executing VerifyTestStepBulkDelete Test Case");				
			...
			{	
				...
				try{
					...
					if(compareStrings(actualAllTestStepsDeleteConfirmationMessage, expectedAllTestStepsDeleteConfirmationMessage) ){
						...
						System.out.println(" Test step Bulk Delete Button Confirmation Message showing Properly stating : " +actualAllTestStepsDeleteConfirmationMessage );
					}
					else
					{
						fail=true;
						...
						System.out.println(" Test step Bulk Delete Button Confirmation Message not showing Properly stating : " +actualAllTestStepsDeleteConfirmationMessage);
					...
					{
						comments+=" All Test Steps are deleted Successfully with Bulk Delete Button";
						APP_LOGS.debug(" All Test Steps are deleted Successfully with Bulk Delete Button");
						System.out.println("All Test Steps are deleted Successfully with Bulk Delete Button");
					}
					else
					{
						fail=true;	
						TestUtil.takeScreenShot(this.getClass().getSimpleName(), "UnsuccessfulBulkDeleteTestCase");
					}
