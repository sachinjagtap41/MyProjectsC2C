...
public class VerifyExportTestStepsOption extends TestSuiteBase{
	...
	// Runmode of test case in a suite
		...
		public void checkTestSkip(){
			...
			System.out.println(" Executing VerifyExportTestStepsOption Test Case");				
			...
			{	
					...
					//	eventfiringdriver.findElement(By.xpath("//span[@id='expTestStep']")).click();
						...
						if(testStepsOptionSuccessMessage==true){
							...
							System.out.println(" Test Step exported successfully stating: " +actualTestStepsOptionSuccessMessage );
						}
						else
						{
							fail=true;
							...
							System.out.println(" Test Step not exported successfully stating: " +actualTestStepsOptionSuccessMessage );
